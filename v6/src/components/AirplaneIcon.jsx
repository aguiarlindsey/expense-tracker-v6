...
const SPEED_LINES = [
  { x1: 5, y1: 15, x2: 1, y2: 19, delay: 0.10 },
  { x1: 7, y1: 17, x2: 3, y2: 21, delay: 0.20 },
  { x1: 9, y1: 19, x2: 5, y2: 23, delay: 0.30 },
]

const AirplaneIcon = forwardRef(function AirplaneIcon(
  { onMouseEnter, onMouseLeave, color, size = 28, style, ...props },
  ref
) {
  ...
  return (
    <div
      ...
      style={{ color, display: 'flex', alignItems: 'center', justifyContent: 'center', ...style }}
      {...props}
    >
      <svg
