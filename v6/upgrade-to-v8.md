...
- [x] **Payment tracking (added 2026-09-19 per user request)**: "✅ Mark month N's EMI paid" button increments `monthsPaid`; the schedule and card badge ("Xmo left" / "🎉 Paid off") both reflect actual progress, not just the original projection
