...
**Status** (updated 2026-09-24): Epic A and all of Epic C are fully built and shipped. Epic B (Household & Multi-User) is in progress: **Phase 0 (Connections + Invites + `profiles`) done 2026-09-24, code-complete pending the two new SQL files being run in Supabase.** Phases 1-3 (Households, Shared Expense Visibility, Real Splits + Settlement) not started.
